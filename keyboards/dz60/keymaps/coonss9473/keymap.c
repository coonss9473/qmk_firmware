...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[2] = LAYOUT_directional(
      ...
      KC_CAPS, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_ENT,
      KC_LSFT,         KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_UP, KC_DEL,
      KC_LCTL, MO(3), KC_LALT, KC_SPC, KC_SPC, KC_SPC, KC_RGUI, ______, KC_LEFT, KC_DOWN, KC_RIGHT
      ),
	[3] = LAYOUT_directional(
      ...
      ______, ______, MO(4), ______, ______, ______, ______, TO(0), ______, ______, ______
      ),
	[4] = LAYOUT_directional(
      ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______,
      ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______,
      ______, ______, ______, ______, ______,  ______, KC_HOME, KC_PAGE_UP, KC_PAGE_DOWN, KC_END, ______, ______,
      ______, ______, ______, ______, ______, ______, ______, ______, KC_MUTE, KC_VOLD, KC_VOLU, ______, ______, ______, ______,
